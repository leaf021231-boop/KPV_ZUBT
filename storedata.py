...
# 神秘度：低=人尽皆知，高=见首不见尾
MYSTERY_TIERS = [
    (-30, "人尽皆知"), (-10, "众所周知"), (10, "略有耳闻"),
    (30, "神秘莫测"), (50, "见首不见尾"), (float("inf"), "传说不存在"),
]

# 名声：低=残忍邪恶，高=仁义无双
REPUTATION_TIERS = [
    (-30, "残忍邪恶"), (-10, "不择手段"), (10, "亦正亦邪"),
    (30, "古道热肠"), (50, "除魔卫道"), (float("inf"), "仁义无双"),
]

# 操守：低=背信弃义，高=一诺千金
INTEGRITY_TIERS = [
    (-30, "背信弃义"), (-10, "见利忘义"), (10, "为人圆滑"),
    (30, "言而有信"), (50, "重信守诺"), (float("inf"), "千金一诺"),
]
